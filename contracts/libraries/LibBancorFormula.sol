...
library BancorFormula {
    ...
    function maxExpArray(uint index) private view returns (uint256) {
        if (index == 0) {
            return 0x6bffffffffffffffffffffffffffffffff;
        } else if (index == 1) {
            return 0x67ffffffffffffffffffffffffffffffff;
        } else if (index == 2) {
            return 0x637fffffffffffffffffffffffffffffff;
        } else if (index == 3) {
            return 0x5f6fffffffffffffffffffffffffffffff;
        } else if (index == 4) {
            return 0x5b77ffffffffffffffffffffffffffffff;
        } else if (index == 5) {
            return 0x57b3ffffffffffffffffffffffffffffff;
        } else if (index == 6) {
            return 0x5419ffffffffffffffffffffffffffffff;
        } else if (index == 7) {
            return 0x50a2ffffffffffffffffffffffffffffff;
        } else if (index == 8) {
            return 0x4d517fffffffffffffffffffffffffffff;
        } else if (index == 9) {
            return 0x4a233fffffffffffffffffffffffffffff;
        } else if (index == 10) {
            return 0x47165fffffffffffffffffffffffffffff;
        } else if (index == 11) {
            return 0x4429afffffffffffffffffffffffffffff;
        } else if (index == 12) {
            return 0x415bc7ffffffffffffffffffffffffffff;
        } else if (index == 13) {
            return 0x3eab73ffffffffffffffffffffffffffff;
        } else if (index == 14) {
            return 0x3c1771ffffffffffffffffffffffffffff;
        } else if (index == 15) {
            return 0x399e96ffffffffffffffffffffffffffff;
        } else if (index == 16) {
            return 0x373fc47fffffffffffffffffffffffffff;
        } else if (index == 17) {
            return 0x34f9e8ffffffffffffffffffffffffffff;
        } else if (index == 18) {
            return 0x32cbfd5fffffffffffffffffffffffffff;
        } else if (index == 19) {
            return 0x30b5057fffffffffffffffffffffffffff;
        } else if (index == 20) {
            return 0x2eb40f9fffffffffffffffffffffffffff;
        } else if (index == 21) {
            return 0x2cc8340fffffffffffffffffffffffffff;
        } else if (index == 22) {
            return 0x2af09481ffffffffffffffffffffffffff;
        } else if (index == 23) {
            return 0x292c5bddffffffffffffffffffffffffff;
        } else if (index == 24) {
            return 0x277abdcdffffffffffffffffffffffffff;
        } else if (index == 25) {
            return 0x25daf6657fffffffffffffffffffffffff;
        } else if (index == 26) {
            return 0x244c49c65fffffffffffffffffffffffff;
        } else if (index == 27) {
            return 0x22ce03cd5fffffffffffffffffffffffff;
        } else if (index == 28) {
            return 0x215f77c047ffffffffffffffffffffffff;
        } else if (index == 29) {
            return 0x1fffffffffffffffffffffffffffffffff;
        } else if (index == 30) {
            return 0x1eaefdbdabffffffffffffffffffffffff;
        } else if (index == 31) {
            return 0x1d6bd8b2ebffffffffffffffffffffffff;
        } else if (index == 32) {
            return 0x1c35fedd14ffffffffffffffffffffffff;
        } else if (index == 33) {
            return 0x1b0ce43b323fffffffffffffffffffffff;
        } else if (index == 34) {
            return 0x19f0028ec1ffffffffffffffffffffffff;
        } else if (index == 35) {
            return 0x18ded91f0e7fffffffffffffffffffffff;
        } else if (index == 36) {
            return 0x17d8ec7f0417ffffffffffffffffffffff;
        } else if (index == 37) {
            return 0x16ddc6556cdbffffffffffffffffffffff;
        } else if (index == 38) {
            return 0x15ecf52776a1ffffffffffffffffffffff;
        } else if (index == 39) {
            return 0x15060c256cb2ffffffffffffffffffffff;
        } else if (index == 40) {
            return 0x1428a2f98d72ffffffffffffffffffffff;
        } else if (index == 41) {
            return 0x13545598e5c23fffffffffffffffffffff;
        } else if (index == 42) {
            return 0x1288c4161ce1dfffffffffffffffffffff;
        } else if (index == 43) {
            return 0x11c592761c666fffffffffffffffffffff;
        } else if (index == 44) {
            return 0x110a688680a757ffffffffffffffffffff;
        } else if (index == 45) {
            return 0x1056f1b5bedf77ffffffffffffffffffff;
        } else if (index == 46) {
            return 0x0faadceceeff8bffffffffffffffffffff;
        } else if (index == 47) {
            return 0x0f05dc6b27edadffffffffffffffffffff;
        } else if (index == 48) {
            return 0x0e67a5a25da4107fffffffffffffffffff;
        } else if (index == 49) {
            return 0x0dcff115b14eedffffffffffffffffffff;
        } else if (index == 50) {
            return 0x0d3e7a392431239fffffffffffffffffff;
        } else if (index == 51) {
            return 0x0cb2ff529eb71e4fffffffffffffffffff;
        } else if (index == 52) {
            return 0x0c2d415c3db974afffffffffffffffffff;
        } else if (index == 53) {
            return 0x0bad03e7d883f69bffffffffffffffffff;
        } else if (index == 54) {
            return 0x0b320d03b2c343d5ffffffffffffffffff;
        } else if (index == 55) {
            return 0x0abc25204e02828dffffffffffffffffff;
        } else if (index == 56) {
            return 0x0a4b16f74ee4bb207fffffffffffffffff;
        } else if (index == 57) {
            return 0x09deaf736ac1f569ffffffffffffffffff;
        } else if (index == 58) {
            return 0x0976bd9952c7aa957fffffffffffffffff;
        } else if (index == 59) {
            return 0x09131271922eaa606fffffffffffffffff;
        } else if (index == 60) {
            return 0x08b380f3558668c46fffffffffffffffff;
        } else if (index == 61) {
            return 0x0857ddf0117efa215bffffffffffffffff;
        } else if (index == 62) {
            return 0x07ffffffffffffffffffffffffffffffff;
        } else if (index == 63) {
            return 0x07abbf6f6abb9d087fffffffffffffffff;
        } else if (index == 64) {
            return 0x075af62cbac95f7dfa7fffffffffffffff;
        } else if (index == 65) {
            return 0x070d7fb7452e187ac13fffffffffffffff;
        } else if (index == 66) {
            return 0x06c3390ecc8af379295fffffffffffffff;
        } else if (index == 67) {
            return 0x067c00a3b07ffc01fd6fffffffffffffff;
        } else if (index == 68) {
            return 0x0637b647c39cbb9d3d27ffffffffffffff;
        } else if (index == 69) {
            return 0x05f63b1fc104dbd39587ffffffffffffff;
        } else if (index == 70) {
            return 0x05b771955b36e12f7235ffffffffffffff;
        } else if (index == 71) {
            return 0x057b3d49dda84556d6f6ffffffffffffff;
        } else if (index == 72) {
            return 0x054183095b2c8ececf30ffffffffffffff;
        } else if (index == 73) {
            return 0x050a28be635ca2b888f77fffffffffffff;
        } else if (index == 74) {
            return 0x04d5156639708c9db33c3fffffffffffff;
        } else if (index == 75) {
            return 0x04a23105873875bd52dfdfffffffffffff;
        } else if (index == 76) {
            return 0x0471649d87199aa990756fffffffffffff;
        } else if (index == 77) {
            return 0x04429a21a029d4c1457cfbffffffffffff;
        } else if (index == 78) {
            return 0x0415bc6d6fb7dd71af2cb3ffffffffffff;
        } else if (index == 79) {
            return 0x03eab73b3bbfe282243ce1ffffffffffff;
        } else if (index == 80) {
            return 0x03c1771ac9fb6b4c18e229ffffffffffff;
        } else if (index == 81) {
            return 0x0399e96897690418f785257fffffffffff;
        } else if (index == 82) {
            return 0x0373fc456c53bb779bf0ea9fffffffffff;
        } else if (index == 83) {
            return 0x034f9e8e490c48e67e6ab8bfffffffffff;
        } else if (index == 84) {
            return 0x032cbfd4a7adc790560b3337ffffffffff;
        } else if (index == 85) {
            return 0x030b50570f6e5d2acca94613ffffffffff;
        } else if (index == 86) {
            return 0x02eb40f9f620fda6b56c2861ffffffffff;
        } else if (index == 87) {
            return 0x02cc8340ecb0d0f520a6af58ffffffffff;
        } else if (index == 88) {
            return 0x02af09481380a0a35cf1ba02ffffffffff;
        } else if (index == 89) {
            return 0x0292c5bdd3b92ec810287b1b3fffffffff;
        } else if (index == 90) {
            return 0x0277abdcdab07d5a77ac6d6b9fffffffff;
        } else if (index == 91) {
            return 0x025daf6654b1eaa55fd64df5efffffffff;
        } else if (index == 92) {
            return 0x0244c49c648baa98192dce88b7ffffffff;
        } else if (index == 93) {
            return 0x022ce03cd5619a311b2471268bffffffff;
        } else if (index == 94) {
            return 0x0215f77c045fbe885654a44a0fffffffff;
        } else if (index == 95) {
            return 0x01ffffffffffffffffffffffffffffffff;
        } else if (index == 96) {
            return 0x01eaefdbdaaee7421fc4d3ede5ffffffff;
        } else if (index == 97) {
            return 0x01d6bd8b2eb257df7e8ca57b09bfffffff;
        } else if (index == 98) {
            return 0x01c35fedd14b861eb0443f7f133fffffff;
        } else if (index == 99) {
            return 0x01b0ce43b322bcde4a56e8ada5afffffff;
        } else if (index == 100) {
            return 0x019f0028ec1fff007f5a195a39dfffffff;
        } else if (index == 101) {
            return 0x018ded91f0e72ee74f49b15ba527ffffff;
        } else if (index == 102) {
            return 0x017d8ec7f04136f4e5615fd41a63ffffff;
        } else if (index == 103) {
            return 0x016ddc6556cdb84bdc8d12d22e6fffffff;
        } else if (index == 104) {
            return 0x015ecf52776a1155b5bd8395814f7fffff;
        } else if (index == 105) {
            return 0x015060c256cb23b3b3cc3754cf40ffffff;
        } else if (index == 106) {
            return 0x01428a2f98d728ae223ddab715be3fffff;
        } else if (index == 107) {
            return 0x013545598e5c23276ccf0ede68034fffff;
        } else if (index == 108) {
            return 0x01288c4161ce1d6f54b7f61081194fffff;
        } else if (index == 109) {
            return 0x011c592761c666aa641d5a01a40f17ffff;
        } else if (index == 110) {
            return 0x0110a688680a7530515f3e6e6cfdcdffff;
        } else if (index == 111) {
            return 0x01056f1b5bedf75c6bcb2ce8aed428ffff;
        } else if (index == 112) {
            return 0x00faadceceeff8a0890f3875f008277fff;
        } else if (index == 113) {
            return 0x00f05dc6b27edad306388a600f6ba0bfff;
        } else if (index == 114) {
            return 0x00e67a5a25da41063de1495d5b18cdbfff;
        } else if (index == 115) {
            return 0x00dcff115b14eedde6fc3aa5353f2e4fff;
        } else if (index == 116) {
            return 0x00d3e7a3924312399f9aae2e0f868f8fff;
        } else if (index == 117) {
            return 0x00cb2ff529eb71e41582cccd5a1ee26fff;
        } else if (index == 118) {
            return 0x00c2d415c3db974ab32a51840c0b67edff;
        } else if (index == 119) {
            return 0x00bad03e7d883f69ad5b0a186184e06bff;
        } else if (index == 120) {
            return 0x00b320d03b2c343d4829abd6075f0cc5ff;
        } else if (index == 121) {
            return 0x00abc25204e02828d73c6e80bcdb1a95bf;
        } else if (index == 122) {
            return 0x00a4b16f74ee4bb2040a1ec6c15fbbf2df;
        } else if (index == 123) {
            return 0x009deaf736ac1f569deb1b5ae3f36c130f;
        } else if (index == 124) {
            return 0x00976bd9952c7aa957f5937d790ef65037;
        } else if (index == 125) {
            return 0x009131271922eaa6064b73a22d0bd4f2bf;
        } else if (index == 126) {
            return 0x008b380f3558668c46c91c49a2f8e967b9;
        } else if (index == 127) {
            return 0x00857ddf0117efa215952912839f6473e6;
        }
    }

    // Auto-generated via 'PrintLambertArray.py'

    function lambertArray(uint index) private view returns (uint256) {
        if (index == 0) {
            return 0x60e393c68d20b1bd09deaabc0373b9c5;
        } else if (index == 1) {
            return 0x5f8f46e4854120989ed94719fb4c2011;
        } else if (index == 2) {
            return 0x5e479ebb9129fb1b7e72a648f992b606;
        } else if (index == 3) {
            return 0x5d0bd23fe42dfedde2e9586be12b85fe;
        } else if (index == 4) {
            return 0x5bdb29ddee979308ddfca81aeeb8095a;
        } else if (index == 5) {
            return 0x5ab4fd8a260d2c7e2c0d2afcf0009dad;
        } else if (index == 6) {
            return 0x5998b31359a55d48724c65cf09001221;
        } else if (index == 7) {
            return 0x5885bcad2b322dfc43e8860f9c018cf5;
        } else if (index == 8) {
            return 0x577b97aa1fe222bb452fdf111b1f0be2;
        } else if (index == 9) {
            return 0x5679cb5e3575632e5baa27e2b949f704;
        } else if (index == 10) {
            return 0x557fe8241b3a31c83c732f1cdff4a1c5;
        } else if (index == 11) {
            return 0x548d868026504875d6e59bbe95fc2a6b;
        } else if (index == 12) {
            return 0x53a2465ce347cf34d05a867c17dd3088;
        } else if (index == 13) {
            return 0x52bdce5dcd4faed59c7f5511cf8f8acc;
        } else if (index == 14) {
            return 0x51dfcb453c07f8da817606e7885f7c3e;
        } else if (index == 15) {
            return 0x5107ef6b0a5a2be8f8ff15590daa3cce;
        } else if (index == 16) {
            return 0x5035f241d6eae0cd7bacba119993de7b;
        } else if (index == 17) {
            return 0x4f698fe90d5b53d532171e1210164c66;
        } else if (index == 18) {
            return 0x4ea288ca297a0e6a09a0eee240e16c85;
        } else if (index == 19) {
            return 0x4de0a13fdcf5d4213fc398ba6e3becde;
        } else if (index == 20) {
            return 0x4d23a145eef91fec06b06140804c4808;
        } else if (index == 21) {
            return 0x4c6b5430d4c1ee5526473db4ae0f11de;
        } else if (index == 22) {
            return 0x4bb7886c240562eba11f4963a53b4240;
        } else if (index == 23) {
            return 0x4b080f3f1cb491d2d521e0ea4583521e;
        } else if (index == 24) {
            return 0x4a5cbc96a05589cb4d86be1db3168364;
        } else if (index == 25) {
            return 0x49b566d40243517658d78c33162d6ece;
        } else if (index == 26) {
            return 0x4911e6a02e5507a30f947383fd9a3276;
        } else if (index == 27) {
            return 0x487216c2b31be4adc41db8a8d5cc0c88;
        } else if (index == 28) {
            return 0x47d5d3fc4a7a1b188cd3d788b5c5e9fc;
        } else if (index == 29) {
            return 0x473cfce4871a2c40bc4f9e1c32b955d0;
        } else if (index == 30) {
            return 0x46a771ca578ab878485810e285e31c67;
        } else if (index == 31) {
            return 0x4615149718aed4c258c373dc676aa72d;
        } else if (index == 32) {
            return 0x4585c8b3f8fe489c6e1833ca47871384;
        } else if (index == 33) {
            return 0x44f972f174e41e5efb7e9d63c29ce735;
        } else if (index == 34) {
            return 0x446ff970ba86d8b00beb05ecebf3c4dc;
        } else if (index == 35) {
            return 0x43e9438ec88971812d6f198b5ccaad96;
        } else if (index == 36) {
            return 0x436539d11ff7bea657aeddb394e809ef;
        } else if (index == 37) {
            return 0x42e3c5d3e5a913401d86f66db5d81c2c;
        } else if (index == 38) {
            return 0x4264d2395303070ea726cbe98df62174;
        } else if (index == 39) {
            return 0x41e84a9a593bb7194c3a6349ecae4eea;
        } else if (index == 40) {
            return 0x416e1b785d13eba07a08f3f18876a5ab;
        } else if (index == 41) {
            return 0x40f6322ff389d423ba9dd7e7e7b7e809;
        } else if (index == 42) {
            return 0x40807cec8a466880ecf4184545d240a4;
        } else if (index == 43) {
            return 0x400cea9ce88a8d3ae668e8ea0d9bf07f;
        } else if (index == 44) {
            return 0x3f9b6ae8772d4c55091e0ed7dfea0ac1;
        } else if (index == 45) {
            return 0x3f2bee253fd84594f54bcaafac383a13;
        } else if (index == 46) {
            return 0x3ebe654e95208bb9210c575c081c5958;
        } else if (index == 47) {
            return 0x3e52c1fc5665635b78ce1f05ad53c086;
        } else if (index == 48) {
            return 0x3de8f65ac388101ddf718a6f5c1eff65;
        } else if (index == 49) {
            return 0x3d80f522d59bd0b328ca012df4cd2d49;
        } else if (index == 50) {
            return 0x3d1ab193129ea72b23648a161163a85a;
        } else if (index == 51) {
            return 0x3cb61f68d32576c135b95cfb53f76d75;
        } else if (index == 52) {
            return 0x3c5332d9f1aae851a3619e77e4cc8473;
        } else if (index == 53) {
            return 0x3bf1e08edbe2aa109e1525f65759ef73;
        } else if (index == 54) {
            return 0x3b921d9cff13fa2c197746a3dfc4918f;
        } else if (index == 55) {
            return 0x3b33df818910bfc1a5aefb8f63ae2ac4;
        } else if (index == 56) {
            return 0x3ad71c1c77e34fa32a9f184967eccbf6;
        } else if (index == 57) {
            return 0x3a7bc9abf2c5bb53e2f7384a8a16521a;
        } else if (index == 58) {
            return 0x3a21dec7e76369783a68a0c6385a1c57;
        } else if (index == 59) {
            return 0x39c9525de6c9cdf7c1c157ca4a7a6ee3;
        } else if (index == 60) {
            return 0x39721bad3dc85d1240ff0190e0adaac3;
        } else if (index == 61) {
            return 0x391c324344d3248f0469eb28dd3d77e0;
        } else if (index == 62) {
            return 0x38c78df7e3c796279fb4ff84394ab3da;
        } else if (index == 63) {
            return 0x387426ea4638ae9aae08049d3554c20a;
        } else if (index == 64) {
            return 0x3821f57dbd2763256c1a99bbd2051378;
        } else if (index == 65) {
            return 0x37d0f256cb46a8c92ff62fbbef289698;
        } else if (index == 66) {
            return 0x37811658591ffc7abdd1feaf3cef9b73;
        } else if (index == 67) {
            return 0x37325aa10e9e82f7df0f380f7997154b;
        } else if (index == 68) {
            return 0x36e4b888cfb408d873b9a80d439311c6;
        } else if (index == 69) {
            return 0x3698299e59f4bb9de645fc9b08c64cca;
        } else if (index == 70) {
            return 0x364ca7a5012cb603023b57dd3ebfd50d;
        } else if (index == 71) {
            return 0x36022c928915b778ab1b06aaee7e61d4;
        } else if (index == 72) {
            return 0x35b8b28d1a73dc27500ffe35559cc028;
        } else if (index == 73) {
            return 0x357033e951fe250ec5eb4e60955132d7;
        } else if (index == 74) {
            return 0x3528ab2867934e3a21b5412e4c4f8881;
        } else if (index == 75) {
            return 0x34e212f66c55057f9676c80094a61d59;
        } else if (index == 76) {
            return 0x349c66289e5b3c4b540c24f42fa4b9bb;
        } else if (index == 77) {
            return 0x34579fbbd0c733a9c8d6af6b0f7d00f7;
        } else if (index == 78) {
            return 0x3413bad2e712288b924b5882b5b369bf;
        } else if (index == 79) {
            return 0x33d0b2b56286510ef730e213f71f12e9;
        } else if (index == 80) {
            return 0x338e82ce00e2496262c64457535ba1a1;
        } else if (index == 81) {
            return 0x334d26a96b373bb7c2f8ea1827f27a92;
        } else if (index == 82) {
            return 0x330c99f4f4211469e00b3e18c31475ea;
        } else if (index == 83) {
            return 0x32ccd87d6486094999c7d5e6f33237d8;
        } else if (index == 84) {
            return 0x328dde2dd617b6665a2e8556f250c1af;
        } else if (index == 85) {
            return 0x324fa70e9adc270f8262755af5a99af9;
        } else if (index == 86) {
            return 0x32122f443110611ca51040f41fa6e1e3;
        } else if (index == 87) {
            return 0x31d5730e42c0831482f0f1485c4263d8;
        } else if (index == 88) {
            return 0x31996ec6b07b4a83421b5ebc4ab4e1f1;
        } else if (index == 89) {
            return 0x315e1ee0a68ff46bb43ec2b85032e876;
        } else if (index == 90) {
            return 0x31237fe7bc4deacf6775b9efa1a145f8;
        } else if (index == 91) {
            return 0x30e98e7f1cc5a356e44627a6972ea2ff;
        } else if (index == 92) {
            return 0x30b04760b8917ec74205a3002650ec05;
        } else if (index == 93) {
            return 0x3077a75c803468e9132ce0cf3224241d;
        } else if (index == 94) {
            return 0x303fab57a6a275c36f19cda9bace667a;
        } else if (index == 95) {
            return 0x3008504beb8dcbd2cf3bc1f6d5a064f0;
        } else if (index == 96) {
            return 0x2fd19346ed17dac61219ce0c2c5ac4b0;
        } else if (index == 97) {
            return 0x2f9b7169808c324b5852fd3d54ba9714;
        } else if (index == 98) {
            return 0x2f65e7e711cf4b064eea9c08cbdad574;
        } else if (index == 99) {
            return 0x2f30f405093042ddff8a251b6bf6d103;
        } else if (index == 100) {
            return 0x2efc931a3750f2e8bfe323edfe037574;
        } else if (index == 101) {
            return 0x2ec8c28e46dbe56d98685278339400cb;
        } else if (index == 102) {
            return 0x2e957fd933c3926d8a599b602379b851;
        } else if (index == 103) {
            return 0x2e62c882c7c9ed4473412702f08ba0e5;
        } else if (index == 104) {
            return 0x2e309a221c12ba361e3ed695167feee2;
        } else if (index == 105) {
            return 0x2dfef25d1f865ae18dd07cfea4bcea10;
        } else if (index == 106) {
            return 0x2dcdcee821cdc80decc02c44344aeb31;
        } else if (index == 107) {
            return 0x2d9d2d8562b34944d0b201bb87260c83;
        } else if (index == 108) {
            return 0x2d6d0c04a5b62a2c42636308669b729a;
        } else if (index == 109) {
            return 0x2d3d6842c9a235517fc5a0332691528f;
        } else if (index == 110) {
            return 0x2d0e402963fe1ea2834abc408c437c10;
        } else if (index == 111) {
            return 0x2cdf91ae602647908aff975e4d6a2a8c;
        } else if (index == 112) {
            return 0x2cb15ad3a1eb65f6d74a75da09a1b6c5;
        } else if (index == 113) {
            return 0x2c8399a6ab8e9774d6fcff373d210727;
        } else if (index == 114) {
            return 0x2c564c4046f64edba6883ca06bbc4535;
        } else if (index == 115) {
            return 0x2c2970c431f952641e05cb493e23eed3;
        } else if (index == 116) {
            return 0x2bfd0560cd9eb14563bc7c0732856c18;
        } else if (index == 117) {
            return 0x2bd1084ed0332f7ff4150f9d0ef41a2c;
        } else if (index == 118) {
            return 0x2ba577d0fa1628b76d040b12a82492fb;
        } else if (index == 119) {
            return 0x2b7a5233cd21581e855e89dc2f1e8a92;
        } else if (index == 120) {
            return 0x2b4f95cd46904d05d72bdcde337d9cc7;
        } else if (index == 121) {
            return 0x2b2540fc9b4d9abba3faca6691914675;
        } else if (index == 122) {
            return 0x2afb5229f68d0830d8be8adb0a0db70f;
        } else if (index == 123) {
            return 0x2ad1c7c63a9b294c5bc73a3ba3ab7a2b;
        } else if (index == 124) {
            return 0x2aa8a04ac3cbe1ee1c9c86361465dbb8;
        } else if (index == 125) {
            return 0x2a7fda392d725a44a2c8aeb9ab35430d;
        } else if (index == 126) {
            return 0x2a57741b18cde618717792b4faa216db;
        } else if (index == 127) {
            return 0x2a2f6c81f5d84dd950a35626d6d5503a;
        }
    }
     ...
     *
     * Formula:
     * return = _reserveBalance * (((_supply + _amount) / _supply) ^ (100000 / _reserveRatio) - 1)
     *
    ...
    /**
     * @dev given a pool token supply, reserve balance, reserve ratio and an amount of requested reserve tokens,
     * calculates the amount of pool tokens required for liquidating the given amount of reserve tokens
     *
     * Formula:
     * return = _supply * (1 - (1 - _amount / _reserveBalance) ^ (_reserveWeight / 1000000))
     *
     * @param _supply          pool token supply
     * @param _reserveBalance  reserve balance
     * @param _reserveWeight   reserve weight, represented in ppm (1-1000000)
     * @param _amount          requested amount of reserve tokens
     *
     * @return reserve token amount
     */
    function liquidateCost(
        ...
        uint256 temp1 = _supply.mul(result);
