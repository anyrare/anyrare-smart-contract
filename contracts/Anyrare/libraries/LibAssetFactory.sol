...
library LibAssetFactory {
    function calculatePayFeeAndClaimTokenFeeLists(
        ...
        ICurrency.TransferCurrency[]
            memory feeLists = new ICurrency.TransferCurrency[](3);
    ...
    function calculateAuctionTransferFeeLists(
        ...
        ICurrency.TransferCurrency[]
            memory feeLists = new ICurrency.TransferCurrency[](9);
        feeLists[0] = ICurrency.TransferCurrency({
    ...
    function calculateOfferTransferFeeLists(
        ...
        ICurrency.TransferCurrency[]
            memory feeLists = new ICurrency.TransferCurrency[](8);
    ...
    function calculateRedeemFeeLists(
        ...
        AssetInfo memory info,
        uint256 auctionValue
    ) public view returns (ICurrency.TransferCurrency[] memory f) {
        IAssetFactory.AssetRedeemFee memory f = calculateRedeemFeeStruct(
            s,
            info,
            auctionValue
        ...
        ICurrency.TransferCurrency[]
            memory feeLists = new ICurrency.TransferCurrency[](6);
        feeLists[0] = ICurrency.TransferCurrency({
            receiver: info.founder,
            amount: f.founderFee
        });
    ...
    function calculateTransferFeeLists(
        ...
        ICurrency.TransferCurrency[]
            memory feeLists = new ICurrency.TransferCurrency[](7);
        feeLists[0] = ICurrency.TransferCurrency({
            receiver: info.founder,
            amount: f.founderFee
        });
