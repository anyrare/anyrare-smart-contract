...
library LibAssetFactory {
    function calculatePayFeeAndClaimTokenFeeLists(
    ...
    ) public view returns (IAssetFactory.TransferARA[] memory fees) {
        ...
        IAssetFactory.TransferARA[]
            memory feeLists = new IAssetFactory.TransferARA[](3);
        ...
        feeLists[2] = IAssetFactory.TransferARA({
    ...
    function calculateAuctionTransferFeeLists(
        ...
        IAssetFactory.TransferARA[]
            memory feeLists = new IAssetFactory.TransferARA[](9);
        feeLists[0] = IAssetFactory.TransferARA({
    ...
    function calculateOfferTransferFeeLists(
        ...
        IAssetFactory.TransferARA[]
            memory feeLists = new IAssetFactory.TransferARA[](8);
    ...
    function calculateRedeemFeeLists(
        ...
        AssetInfo memory info,
        uint256 auctionValue
    ) public view returns (IAssetFactory.TransferARA[] memory f) {
        IAssetFactory.AssetRedeemFee memory f = calculateRedeemFeeStruct(
            s,
            info,
            auctionValue
        ...
        IAssetFactory.TransferARA[]
            memory feeLists = new IAssetFactory.TransferARA[](6);
        feeLists[0] = IAssetFactory.TransferARA({
            receiver: info.founder,
            amount: f.founderFee
        });
    ...
    function calculateTransferFeeLists(
        ...
        IAssetFactory.TransferARA[]
            memory feeLists = new IAssetFactory.TransferARA[](7);
        feeLists[0] = IAssetFactory.TransferARA({
            receiver: info.founder,
            amount: f.founderFee
        });
