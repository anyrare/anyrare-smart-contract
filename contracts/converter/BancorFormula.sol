...
contract BancorFormula is IBancorFormula {
  ...
  function balancedWeights(
    ...
    if (_primaryReserveStakedBalance == _primaryReserveBalance)
      require(
        _primaryReserveStakedBalance > 0 || _secondaryReserveBalance > 0,
        "ERR_INVALID_RESERVE_BALANCE"
      );
    else
      require(
  ...
  function calculatePurchaseReturn(
    ...
    return
      purchaseTargetAmount(_supply, _reserveBalance, _reserveWeight, _amount);
  }
  ...
  function calculateLiquidateReturn(
    ...
    return
      liquidateReserveAmount(_supply, _reserveBalance, _reserveRatio, _amount);
  }
