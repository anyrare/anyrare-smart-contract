...
describe("DiamondTest", async function() {
  ...
  // it("should have 3 facets -- call to facetAddresses function", async () => {
  ...
  // it('should test function callAdd', async () => {
  //   const test1Facet = await ethers.getContractAt('Test1Facet', diamondAddress)
  //   const test2Facet = await ethers.getContractAt('Test2Facet', diamondAddress)
  //   const result = await test2Facet.callAdd()
  //   const resultCall = await test2Facet.callAddView();
  //   console.log("callAdd: ", result);
  //   console.log("callAddView: ", resultCall);

  //   const resultCallAddViewTest1 = await test1Facet.callAddViewTest1();
  //   console.log("callAddViewTest1: ", resultCallAddViewTest1);
  // })

  it("should test function callAdd2", async () => {
    const test2Facet = await ethers.getContractAt("Test2Facet", diamondAddress);
    const result = await test2Facet.callAdd2();
    const resultCall = await test2Facet.callAddView();
    console.log("callAdd2: ", result);
    console.log("callAddView: ", resultCall);

    const result1 = await test2Facet.callAddAndSave();
    const result1Call = await test2Facet.callAddView();
    console.log("call1Add2: ", result1);
    console.log("call1AddView: ", result1Call);
  });
  ...
  it("should test function callSender", async () => {
    ...
    console.log("callSenderStorageView: ", resultCallStorage2);
    console.log("diamondAddress: ", diamondAddress);
    console.log("diamondCutAddress: ", diamondCutFacet.address);
